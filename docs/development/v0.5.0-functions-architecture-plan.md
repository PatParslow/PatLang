...
- [ ] Extend [`Token`](src/token.rb:4) types: `FUNCTION`, `MAKE`, `CALLED`, `TAKES`, `RETURNS`
- [ ] Implement [`FunctionDefinitionNode`](src/ast_nodes.rb:179) and related AST nodes
- [ ] Extend [`Lexer`](src/lexer.rb:1) for natural language function keywords
- [ ] Basic [`Parser`](src/parser.rb:1) grammar for function definitions

#### Week 2: Core Functionality (June 15-21, 2025)
- [ ] Function call parsing and AST generation
- [ ] [`Evaluator`](src/evaluator.rb:1) function definition storage
