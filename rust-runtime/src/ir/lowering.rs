...
impl Lowerer {
    ...
    fn is_allowed_host(&self, name: &str) -> bool {
        matches!(name,
            ...
            "list_get"|"list_len"|"list_push"|"list_set"|"char_code"|"substr"|"chr"|"to_num"|"read_file"|"write_file"|"argv"|"compile_shape"|"compile_ir"|"run_ir"|"codegen_prelude"|"rustc_build"|
